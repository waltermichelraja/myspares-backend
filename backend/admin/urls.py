...
from .views import (
    list_brands, insert_brand, delete_brand, fetch_brand, search_brand, update_brand,
    list_models, insert_model, delete_model, fetch_model, search_model, update_model,
    list_categories, insert_category, delete_category, fetch_category, search_category, update_category,
    list_products, insert_product, delete_product, fetch_product, search_product, update_product,
)
...
urlpatterns=[
     ...
     path("brands/search/<str:query>/", search_brand, name="search_brands"),
     ...
     path("brands/<str:brand_code>/models/search/<str:query>/", search_model, name="search_models"),
     ...
     path("brands/<str:brand_code>/models/<str:model_code>/categories/search/<str:query>/", search_category, name="search_categories"),
     ...
     path("brands/<str:brand_code>/models/<str:model_code>/categories/<str:category_code>/products/search/<str:query>/",
          search_product, name="search_products"),
